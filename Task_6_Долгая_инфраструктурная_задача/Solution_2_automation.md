...
Запустила тестовый пайплайн. По идее с ним все ок после миграции. 
 
Я столкнулась с парой ошибок, но они были связаны не с миграцией.
1. При повторном прохождении при регистрации раннера я указала старый ip вместо ip nginx, поэтому редирект не работал
2. Я делала пуш из старого локального репо (остался после первого прохождения), не обновив ссылки на адрес nginx. 
